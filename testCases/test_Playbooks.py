...
class TestPlaybook(Base):
    ...
    #     Validation - 1. Based on the window title
    #     """
    #     log = self.getlogger()
    #     action = Action(self.driver)
    #     playbooks = Playbooks(self.driver)
    ...
    #       Validation - 1. Based on the add node slider title
    #     """
    #     log = self.getlogger()
    #     playbooks = Playbooks(self.driver)
    ...
    #        Validation - 1. Based on the nodes category title
    #     """
    #     log = self.getlogger()
    #     playbooks = Playbooks(self.driver)
    ...
    #         Validation: Based on the sub-playbooks tab color
    #     """
    #     log = self.getlogger()
    #     playbooks = Playbooks(self.driver)
    ...
    #     """
    #     log = self.getlogger()
    #     filter_and_sort = FilterAndSort(self.driver)
    #     log.info("Click on the filter button")
    #     filter_and_sort.click_on_filters()
    #     log.info("Read the filter slider title")
    #     slider_txt = filter_and_sort.get_filters_slider_title()
    #     log.info("Close filter")
    #     filter_and_sort.close_filter_btn()
