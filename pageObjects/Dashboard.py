...
class Dashboard(Action):
    ...
    def click_on_view_all_btn(self, element):
        return Action.wait_and_click(self, By.XPATH, element)
    ...
    def click_maximize_btn(self):
        return Action.wait_and_click(self, By.XPATH, Dashboard.btn_maximize)

    btn_minimize = "//i[@class='icon icon-collapse']/parent::button"

    def click_minimize_btn(self):
        return Action.wait_and_click(self, By.XPATH, Dashboard.btn_minimize)
    ...
    def click_dark_mode_btn(self):
        return Action.wait_and_click(self, By.XPATH, Dashboard.btn_dark_mode)
    ...
    def click_light_mode_btn(self):
        return Action.wait_and_click(self, By.XPATH, Dashboard.btn_light_mode)

    btn_sync = "//i[@class='icon icon-refresh']/parent::button"

    def click_sync_btn(self):
        return Action.wait_and_click(self, By.XPATH, Dashboard.btn_sync)
    ...
    def click_start_date_btn(self):
        return Action.wait_and_click(self, By.XPATH, Dashboard.start_date_btn)

    select_end_date = "(//tr[@class='el-date-table__row']/td[contains(@class,'available')]//span)[3]"

    def select_calendar_end_date(self):
        return Action.wait_and_click(self, By.XPATH, Dashboard.select_end_date)
    ...
    def select_calendar_start_date(self):
        return Action.wait_and_click(self, By.XPATH, Dashboard.select_start_date)
    ...
    def click_on_back_btn(self):
        return Action.wait_and_click(self, By.XPATH, Dashboard.btn_back)
