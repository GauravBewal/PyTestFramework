...
class Navigation(Action):
    ...
    def click_main_menu(self):
        return Action.wait_and_click(self, By.CSS_SELECTOR, Navigation.nav_main_menu)
    ...
    def enable_menu_synopsis(self):
        return Action.wait_and_click(self, By.XPATH, Navigation.activate_synopsis_tool_tips)

    deactivate_menu_synopsis = "//div[@class='cy-switch-btn-wrapper__icon']"

    def disable_menu_synopsis(self):
        return Action.wait_and_click(self, By.XPATH, Navigation.deactivate_menu_synopsis)

    nav_admin_menu = "i.icon.icon-settings-gear"

    def click_admin_menu(self):
        return Action.wait_and_click(self, By.CSS_SELECTOR, Navigation.nav_admin_menu)
    ...
    def navigate_dashboard(self):
        return Action.wait_and_click(self, By.XPATH, Navigation.nav_dashboard)
    ...
    def get_playbook_menu_synopsis_text(self):
        return Action.wait_and_click(self, By.XPATH, Navigation.nav_playbook_menu_tooltip)

    nav_manage_playbook = "//div[contains(@class,'menu-playbook')]"

    def navigate_manage_playbook(self):
        return Action.wait_and_click(self, By.XPATH, Navigation.nav_manage_playbook)

    nav_run_logs = "//div[@class='cs-menu-item--title color-n500 font-size-14'][normalize-space()='Run Logs']"

    def navigate_run_logs(self):
        return Action.wait_and_click(self, By.XPATH, Navigation.nav_run_logs)
    ...
    def navigate_configure_event(self):
        return Action.wait_and_click(self, By.XPATH, Navigation.nav_configure_event)
    ...
    def navigate_data_sync(self):
        return Action.wait_and_click(self, By.XPATH, Navigation.nav_data_sync)

    nav_apps = "//div[@class='cs-menu-item--title font-weight-500 color-n800 font-size-15'][normalize-space()='Apps']"

    def navigate_apps(self):
        return Action.wait_and_click(self, By.XPATH, Navigation.nav_apps)
    ...
    def navigate_agent_task(self):
        return Action.wait_and_click(self, By.XPATH, Navigation.nav_agent_task)

    nav_labels = "//div[@class='cs-menu-item--title color-n500 font-size-14'][normalize-space()='Labels']"

    def navigate_labels(self):
        return Action.wait_and_click(self, By.XPATH, Navigation.nav_labels)
